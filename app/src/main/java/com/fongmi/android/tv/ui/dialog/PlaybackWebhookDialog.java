...
public class PlaybackWebhookDialog extends BaseAlertDialog {
    ...
    private static final List<String> BASIC_FIELDS = Arrays.asList("schema", "event", "eventId", "timestamp", "sessionId", "dedupeKey", "cid", "configKey", "configName", "historyKey", "siteKey", "siteName", "vodId", "vodName", "vodPic", "flag", "episodeName", "state", "positionMs", "durationMs", "progress", "speed", "speedOverride", "completed");
    private static final List<String> STANDARD_FIELDS = Arrays.asList("schema", "event", "eventId", "timestamp", "sessionId", "dedupeKey", "cid", "configKey", "configName", "historyKey", "siteKey", "siteName", "vodId", "vodName", "vodPic", "flag", "episodeName", "state", "positionMs", "durationMs", "progress", "speed", "speedOverride", "completed", "appVersion", "client");
    private static final List<String> FULL_FIELDS = Arrays.asList("schema", "event", "eventId", "timestamp", "sessionId", "dedupeKey", "cid", "configKey", "configName", "historyKey", "siteKey", "siteName", "vodId", "vodName", "vodPic", "flag", "episodeName", "state", "positionMs", "durationMs", "progress", "speed", "speedOverride", "completed", "appVersion", "client", "episodeUrl", "episodeIndex", "clientKey");
    private static final List<String> ANONYMOUS_FIELDS = Arrays.asList("schema", "event", "eventId", "timestamp", "sessionId", "dedupeKey", "historyKey(sha256)", "state", "positionMs", "durationMs", "progress", "speed", "speedOverride", "completed");
