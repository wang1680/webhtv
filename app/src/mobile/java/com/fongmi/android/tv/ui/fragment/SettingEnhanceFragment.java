...
public class SettingEnhanceFragment extends BaseFragment {
    ...
    private void setTmdbModel(View view) {
        new MaterialAlertDialogBuilder(requireActivity()).setTitle(R.string.setting_tmdb_model).setNegativeButton(R.string.dialog_negative, null).setSingleChoiceItems(getTmdbModels(), getTmdbModelIndex(), (dialog, which) -> {
